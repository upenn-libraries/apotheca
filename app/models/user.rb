...
class User < ApplicationRecord
  ...
  has_many :bulk_exports, foreign_key: 'created_by_id', dependent: :destroy, inverse_of: :user
  has_many :bulk_imports, foreign_key: 'created_by_id', dependent: :destroy, inverse_of: :user
