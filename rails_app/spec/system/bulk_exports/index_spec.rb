    ...
    describe 'viewing a bulk export' do
      context 'when it is queued' do
        ...
        it 'can be cancelled' do
          accept_confirm('Do you really want to cancel this bulk export?') { click_on 'Cancel Export' }
      ...
      context 'when it is cancelled' do
        ...
        it 'can be deleted' do
          accept_confirm('Do you really want to delete this bulk export?') { click_on 'Delete Export' }
      ...
      context 'when it is failed' do
        ...
        it 'can be regenerated' do
          accept_confirm('Do you really want to regenerate this bulk export?') { click_on 'Regenerate' }
