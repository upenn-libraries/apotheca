...
export default class extends Controller {
    ...
    dragstart(event) {
        ...
        draggedAsset.className = "card asset-card mb-1 g-0 border border-primary border-3 rounded-1"
    }
    ...
    drop(event) {
        ...
        const draggedAsset = this.element.querySelector(`[data-asset-id='${asset_id}']`)
        draggedAsset.className = "card asset-card mb-1 g-0 border border-3 rounded-1"
