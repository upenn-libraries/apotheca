...
## Context
The current publishing mechanism as described in the previous publishing ADR (0008_publishing.md) was working well, but after adding the new API endpoints, considering supporting new consumer applications and entities, we believe it's worthwhile to improve upon our publishing mechanism. Some issues/limitations with the current publishing mechanism listed below.
